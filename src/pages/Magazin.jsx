...
export default function Magazin() {
  const {handleSubmit2,list,store,setStore,removeItem}=useGlobalContext()
  return (
    <div>
      <h1 className='text-4xl font-semibold px-4 py-11'>Настройки магазинов</h1>
      <hr />
      <div>
      <form onSubmit={handleSubmit2} className='flex items-center gap-8 relative mt-9 mb-9'>
       ...
       required
        ...
        <button className='flex gap-4 items-center text-white px-4 py-4 rounded-s-2xl rounded-e-2xl font-semibold bg-blue-500'>
          <img src={plus} />
        Новый магазин
        </button>
      </form>
